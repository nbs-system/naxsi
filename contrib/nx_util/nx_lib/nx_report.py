...
class NxReport(object):
    ...
    def render_GET(self, render):
        # try:
        #     fd = open(self.data_dir+'/graphs.tpl')
        #     html = ''
        #     for i in fd:
        #         html += i
        #     fd.close()
        # except:
        #     return "Unable to open graphs template ["+self.data_dir+"]"
        html = render
