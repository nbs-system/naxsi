...
#            self.log.warning( "connecting to "+self.dbname)
    ...
    def create_all_tables(self):
        if self.dbtype == 'mysql':
            ...
            self.execute("CREATE TABLE exceptions (exception_id INTEGER auto_increment, zone TEXT, var_name TEXT, rule_id INTEGER , content TEXT, primary key (exception_id, rule_id))")            
        elif self.dbtype == 'sqlite':
            ...
            self.execute("CREATE TABLE exceptions (exception_id INTEGER PRIMARY KEY AUTOINCREMENT, zone TEXT, var_name TEXT, rule_id INTEGER, content TEXT)")
